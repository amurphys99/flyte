export default async function handler(req: any, res: any) {
  ...
  const privateKey = process.env.KLAVIYO_PRIVATE_KEY?.trim();
  ...
  // Step 1: Subscribe the email to the list
  ...
  // Step 2: Update profile with name fields (profile-import upserts by email)
